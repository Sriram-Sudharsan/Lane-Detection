...
cap = cv2.VideoCapture('/home/linlite/Desktop/lane-detection-and-turn-prediction/Code/improve_video_quality/drive.mp4')
out = cv2.VideoWriter('outpy3.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 20, (1000,700))
